import torch, os
from utils import DATA_URL, Vocabulary, download_extract, load_array
...
def load_data_nmt(batch_size, num_steps, num_examples=600):
    ...
    def read_dataset_nmt():
        ...
        """
        data_dir = download_extract(DATA_HUB, name='fra-eng', save_folder_name='french_to_english')
    ...
    src_vocab = Vocabulary(source, min_freq=2, reserved_tokens=['<pad>', '<bos>', '<eos>'])
    tgt_vocab = Vocabulary(target, min_freq=2, reserved_tokens=['<pad>', '<bos>', '<eos>'])
